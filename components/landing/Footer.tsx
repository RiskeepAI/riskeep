      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-[#6b768b] leading-relaxed max-w-xs">
              {t.footer.description}
            </p>
            {/* Bitget badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border border-white/8 bg-white/3">
              <span className="w-1.5 h-1.5 rounded-full bg-green-500"/>
              <span className="text-xs text-[#6b768b]">Compatible con <span className="text-[#dbe6fe]">Bitget</span></span>
            </div>
          </div>

          {/* Col 2: Nav links */}
          <div className="space-y-3">
            <p className="text-[10px] font-mono uppercase tracking-[0.18em] text-[#3d4f6e]">{t.footer.navLabel}</p>
            <nav className="flex flex-col gap-2">
              {[
                ...
                <Link key={href} href={href} className="text-sm text-[#6b768b] hover:text-[#dbe6fe] transition-colors w-fit">
                  {label}
                </Link>
              ))}
            </nav>
          ...
          <div className="space-y-3">
            <p className="text-[10px] font-mono uppercase tracking-[0.18em] text-[#3d4f6e]">{t.footer.contact}</p>
            <a href="mailto:support@riskeep.com" className="text-sm text-[#6b768b] hover:text-[#dbe6fe] transition-colors block w-fit">
              support@riskeep.com
            </a>
            <div className="flex items-center gap-3 pt-1">
              <a href="https://t.me/riskeep" target="_blank" rel="noopener noreferrer"
                 className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-white/8 bg-white/3 text-xs text-[#6b768b] hover:text-[#dbe6fe] hover:border-white/16 transition-all">
        ...
        <div className="border-t border-white/6 pt-6 space-y-3">
          <p className="text-center text-xs text-[#3d4f6e] leading-relaxed max-w-2xl mx-auto">
            {t.footer.disclaimer}
          </p>
